	...
	<li class="btn-group">
		...
		<div class="form-group">
			<div class="dropdown"><!-- ipSearchVo -->
				...
				<input type="hidden" name="stdept_list_search_id" id="stdept_list_search_id"
		...
		<div class="form-group">
			<p class="list-btn-search-wrap">
				<input type="text" name="stdept_list_search_value" id="stdept_list_search_value" class="search-input"
					value="<c:out value="${deptSearchVo.search_value}" default=""/>"
					placeholder="부서코드/부서명을 입력해 주세요." />
				<button type="submit" class="search-icon" onclick="stdept_list_search();">
